...
// Check to see if any Zen Cart tables exist
    ...
    function check_version_1141() {
      ...
      if (ZC_UPG_DEBUG==true) echo "114patch-fields=" . $result->fields['configuration_title'] . '<br>';
        if  ($result->fields['configuration_title'] == '小包裹包装材料 - 百分比+重量') {
    ...
    function check_version_120() {
      ...
      while (!$result->EOF) {
        ...
        if ($result->fields['configuration_group_title'] == '属性设置') {
          $got_v1_2_0c = true;
        }
        $result->MoveNext();
      }
     ...
     $sql = "show fields from " . DB_PREFIX . "categories";
      ...
      if ($got_v1_2_0a && $got_v1_2_0b && $got_v1_2_0c && $got_v1_2_0d && $got_v1_2_0e && $got_v1_2_0f) {
        $got_v1_2_0 = true;
        if (ZC_UPG_DEBUG==true) echo '已有 1.2.0<br>';
      }
      return $got_v1_2_0;
    } // end 1.2.0 check
    ...
    function check_version_121() {
      ...
      if ($got_v1_2_1a && $got_v1_2_1b) {
        $got_v1_2_1 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.2.1<br>';
      }
      return $got_v1_2_1;
    } //end of 1.2.1 check
    ...
    function check_version_122() {
      ...
      if  ($result->fields['configuration_title'] == '发送订单确认电子邮件的复件到') {
        $got_v1_2_2a = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.2.2<br>';
      }
      return $got_v1_2_2a;
    } //end of 1.2.2 check
    ...
    function check_version_123() {
      ...
      if  ($result->fields['configuration_title'] == '缺省的金额为零的订单状态') {
        $got_v1_2_3 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.2.3<br>';
      }
      return $got_v1_2_3;
    } //end of 1.2.3 check
    ...
    function check_version_124() {
      ...
      if  ($result->fields['configuration_title'] == '厂商列表 - 检验商品存在') {
        $got_v1_2_4 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.2.4<br>';
      }
      return $got_v1_2_4;
    } //end of 1.2.4 check
    ...
    function check_version_125() {
      ...
      if  ($result->fields['configuration_title'] == 'IP到主机名转换') {
        $got_v1_2_5a = true;
      }
      ...
      if  ($result->fields['configuration_title'] == '商品链接多个分类的显示') {
        $got_v1_2_5b = true;
      }
      ...
      if ($got_v1_2_5a && $got_v1_2_5b && $got_v1_2_5c && $got_v1_2_5d) {
        $got_v1_2_5 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.2.5<br>';
      }
      return $got_v1_2_5;
    } // end 1.2.5 check
    ...
    function check_version_126() {
      ...
      if  ($result->fields['configuration_title'] == '分类标签菜单 打开/关闭') {
        $got_v1_2_6 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.2.6<br>';
      }
      return $got_v1_2_6;
    }  // end 1.2.6 check
    ...
    function check_version_127() {
      ...
      if  ($result->fields['configuration_description'] == '自动显示是否有Zen Cart新版本。打开该选项有时会降低管理页面打开时间。(显示于登录后的主索引页面和服务器信息页面)') {
        $got_v1_2_7a = true;
      }
      //check #2
      ...
      if  ($result->fields['configuration_description'] == '是否显示购物车边框<br />0= 总是显示<br />1= 满的时候<br />2= 满的时候，但查看购物车时不显示') {
        $got_v1_2_7b = true;
      }
      if (ZC_UPG_DEBUG==true) {
      ...
      if ($got_v1_2_7a && $got_v1_2_7b) {
        $got_v1_2_7 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.2.7<br>';
      }
      return $got_v1_2_7;
    }  // end 1.2.7 check
    ...
    function check_version_130() {
      ...
      if  ($result->fields['configuration_title'] == '导航条') {
        $got_v1_3_0a = true;
      }
      ...
      if  ($result->fields['configuration_title'] == '简易页面 - 页眉') {
        $got_v1_3_0c = true;
      }
      //4th check for 1.3.0
      ...
      if  ($result->fields['configuration_title'] == '电子邮件必须从现有域名发送') {
        $got_v1_3_0e = true;
      }
      ...
      if  ($result->fields['configuration_title'] == 'CSS按钮') {
        $got_v1_3_0f = true;
      }
      ...
      if ($got_v1_3_0a && $got_v1_3_0b && $got_v1_3_0c && $got_v1_3_0d && $got_v1_3_0e && $got_v1_3_0f  ) {
        $got_v1_3_0 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.3.0<br>';
      }
      return $got_v1_3_0;
    } //end of 1.3.0 check
    ...
    function check_version_135() {
      ...
      if  ($result->fields['configuration_title'] == '显示添加到购物车按钮 (0=关; 1=开; 2=开，且可以输入数量)') {
        $got_v1_3_5a = true;
      }
      ...
      if  ($result->fields['configuration_title'] == '商品列表中显示字母过滤选择') {
        $got_v1_3_5b = true;
      }
      ...
      if ($got_v1_3_5a && $got_v1_3_5b ) {
        $got_v1_3_5 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.3.5<br>';
      }
      return $got_v1_3_5;
    } //end of 1.3.5 check
    ...
    function check_version_136() {
      ...
      if  ($result->fields['configuration_title'] == '元标签 - 标题含商品型号') {
        $got_v1_3_6a = true;
      }
      ...
      if  ($result->fields['configuration_title'] == '在空购物车页面显示预售商品') {
        $got_v1_3_6b = true;
      }
      ...
      if ($got_v1_3_6a && $got_v1_3_6b ) {
        $got_v1_3_6 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.3.6<br>';
      }
      return $got_v1_3_6;
    } //end of 1.3.6 check
    ...
    function check_version_137() {
      ...
      if  ($result->fields['configuration_description'] == '是否显示导航条<br />0= 关<br />1= 开<br />2= 仅不显示在首页') {
        $got_v1_3_7a = true;
      }
      ...
      if  ($result->fields['configuration_title'] == '分开登录页面') {
        $got_v1_3_7b = true;
      }
      ...
      if ($got_v1_3_7a && $got_v1_3_7b ) {
        $got_v1_3_7 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.3.7<br>';
      }
      return $got_v1_3_7;
    } //end of 1.3.7 check
    ...
    function check_version_138() {
      ...
      if  ($result->fields['configuration_title'] == '登录时提醒合并购物车') {
        $got_v1_3_8a = true;
      }
      ...
      if  ($result->fields['configuration_title'] == '边框中随机推荐商品数量') {
        $got_v1_3_8b = true;
      }
      ...
      if ($got_v1_3_8a && $got_v1_3_8b ) {
        $got_v1_3_8 = true;
        if (ZC_UPG_DEBUG==true) echo '<br>已有 1.3.8<br>';
      }
      return $got_v1_3_8;
    } //end of 1.3.8 check
    ...
    function check_version_139() {
      ...
      if  ($result->fields['configuration_title'] == '分开显示税项') {
        $got_v1_3_9a = true;
      }
    ...
    function check_version_150() {
      ...
      if ($got_v1_5_0a && $got_v1_5_0b ) {
        $got_v1_5_0 = true;
        if (ZC_UPG_DEBUG==true) echo '已有 1.5.0<br><br>';
      }
      return $got_v1_5_0;
    } //end of 1.5.0 check
    ...
    function check_version_151() {
      ...
      while (!$result->EOF && !$got_v1_5_1) {
        ...
        if  ($result->fields['Field'] == 'ip_address' && strtoupper($result->fields['Type']) == 'VARCHAR(45)') {
          $got_v1_5_1 = true;
          if (ZC_UPG_DEBUG==true) echo '已有 1.5.1<br><br>';
        }
        $result->MoveNext();
      }
      return $got_v1_5_1;
    ...
    function check_version_152() {
      ...
      if  ($result->fields['configuration_description'] == '指向 configure.php 文件中 DIR_FS_SQL_CACHE 设定的目录。') {
        $got_v1_5_2b = true;
