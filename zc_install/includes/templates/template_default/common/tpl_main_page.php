...
<div id="wrap">
  <div id="header">
  <img src="<?php echo DIR_WS_INSTALL_TEMPLATE; ?>images/zen_header_bg.jpg" alt="Zen Cart中文版 - 电子商务的艺术" title="Zen Cart中文版"/>
  </div>
  <div id="content">
  ...
  <div id="footer">
    <p>版权所有 &copy; 2004-<?php echo date('Y'); ?> <a href="http://www.zen-cart.cn" target="_blank">Zen Cart 中文版</a></p>
  </div>
</div>
