...
<title>Zen Cart中文版安装 - 加载数据库 ...</title>
...
<?php
         ...
         if ($zc_show_progress == 'yes') {
           ...
           $link = '<a href="' . $linkto . '">' . '<br /><br />完成!<br />点这里继续<br /><br />' . '</a>';
           echo "\n<script type=\"text/javascript\">\nwindow.location=\"$linkto\";\n</script>\n";
           echo '<noscript>'.$link.'</noscript><br /><br />';
           echo '<div id="footer"><p>版权所有 &copy; 2003-' . date('Y') . ' <a href="http://www.zen-cart.cn" target="_blank">Zen Cart中文版</a></p></div></div></body></html>';
         } else {
  ...
  if ($is_upgrade) { // read previous settings from configure.php
    ...
    if ($zdb_coll != 'utf8') $zdb_coll = 'utf8';
