 ...
 */
  ...
  if (!isset($_POST['store_country'])) $_POST['store_country'] = '44';
  if (!isset($_POST['store_zone'])) $_POST['store_zone'] = '131';
  if (!isset($_POST['store_address'])) $_POST['store_address'] = STORE_ADDRESS_DEFAULT_VALUE;
  if (!isset($_POST['store_default_language'])) $_POST['store_default_language'] = 'gb';
  if (!isset($_POST['store_default_currency'])) $_POST['store_default_currency'] = 'CNY';

  @require_once('../includes/configure.php');
  if (!defined('DB_TYPE') || DB_TYPE=='') {
    echo('数据库类型不对。configure.php 文件可写吗?');
